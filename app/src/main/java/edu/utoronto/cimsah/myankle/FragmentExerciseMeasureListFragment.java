...
public class FragmentExerciseMeasureListFragment extends Fragment implements AccelerometerListener, OnSeekBarChangeListener {

	public static final String TAG = FragmentExerciseMeasureListFragment.class.getSimpleName();
	...
	public static FragmentExerciseMeasureListFragment newInstance(int exercise_id) {

		// Create and populate a bundle to instantiate the fragment with
		FragmentExerciseMeasureListFragment myFragment = new FragmentExerciseMeasureListFragment();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Init hardware
		mAccelerometer = AccelerometerManager.get(getActivity()).registerListenerAndConnect(this);
	...
	private void backToInstructionFragment() {
		...
		String backStackName = FragmentExercisesListFragment.TAG;
